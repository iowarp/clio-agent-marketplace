...
**Related skills**: `hdf5_vol_usage` (maps require a VOL connector implementing the map API). Consult the HDF5 VOL developer documentation when implementing a map-capable connector.
