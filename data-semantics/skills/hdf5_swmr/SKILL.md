...
**Related skills**: `hdf5_io` for I/O optimization, `hdf5_chunking` for chunk configuration, `hdf5_parallel` for MPI-based concurrent access.
...
- Network filesystem required (use `hdf5_parallel` with MPI instead)
