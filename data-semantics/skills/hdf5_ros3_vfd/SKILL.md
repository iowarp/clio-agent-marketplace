...
**Related skills**: `hdf5_cloud_optimized` for writing files optimized for S3 access, `hdf5_chunking` for chunk size configuration.
...
- **Cloud-optimize files before uploading** -- use paged aggregation and 10-100 MB chunks (see `hdf5_cloud_optimized` skill)
